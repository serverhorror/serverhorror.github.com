...
<p>To make that stuff permanent add it as a <tt>pre-up</tt> to your <tt>/etc/network/interfaces</tt> file under the appropriate stanza<br />
...
<p>It populates <tt>/srv/fai/nfs</tt> and <tt>/srv/fai/config</tt> with some basic stuff which you can use to install clients right away (well nearly, we need to finish some steps to actually be able to install...)<br />
